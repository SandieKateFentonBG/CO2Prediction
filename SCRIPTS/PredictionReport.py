    ...
    if displayParams['archive']:
        ...
        with open(outputPathStudy + modelGS.predictorName + "_FS.txt", 'w', encoding='UTF8', newline='') as e:
            ...
            for DfLabel in modelGS.learningDfsList:
                ...
                writer.writerow(['GS TestAcc_std ', GS.TestAcc_std])
                writer.writerow(['GS TestAcc_mean ', GS.TestAcc_mean])
        ...
        if display:
            ...
            for DfLabel in modelGS.learningDfsList:
                ...
                print('GS TestAcc_mean :', GS.TestAcc_mean)
                print('GS TestAcc_std :', GS.TestAcc_std)
