...
# sample_nb = 42
# sample_values = list(range(42, 43))
...
#
# xQualLabels = ['Stage','Sector', 'Construction', 'Passive', 'Basement',
#                'Foundation', 'Ground_Floor', 'Superstructure', 'Cladding', 'Fire_Rating', 'Value_Type']#'Location',
...
# Summed_Labels = {'Carbon_A123-C34_kgCO2e' : ['Carbon_A1-A3_kgCO2e', 'Carbon C3-C4 (kgCO2e)']}
...
#
# labels_2D_norm = [['Carbon A1-A3 (kgCO2e)', 'A1-A3_Rate_kgCO2e-m2', 'Carbon_A1-A3_kgCO2e_normalize', 'A1-A3_Rate_kgCO2e-m2_normalize'],
